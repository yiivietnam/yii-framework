...
class Category extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('is_public, del_flg', 'numerical', 'integerOnly'=>true),
			array('slug, title', 'length', 'max'=>255),
			array('description, created, modified', 'safe'),
			array('slug', 'unique', 'className'=>'Category', 'attributeName'=>'slug',
				'criteria' => array(
			...
			array('id, slug, title, description, is_public, created, modified, del_flg', 'safe', 'on'=>'search'),
