...
/**
 * This is the model class for table "tbl_example".
 *
 * The followings are the available columns in table 'tbl_example':
 * @property integer $id
...
class Example extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, title, description, file, is_public, created, modified', 'safe', 'on'=>'search'),
		);
	}
